...
@section('page-title', 'Creer un plan')
...
<div class="mt-2 max-w-lg">
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-6">
        <h2 class="text-lg font-semibold text-gray-900 mb-6">Nouveau plan</h2>
        ...
        <form action="{{ route('admin.plans.store') }}" method="POST" class="space-y-5">
            ...
            <div>
                ...
                <input type="text" name="name" value="{{ old('name') }}"
                    ...
                    required placeholder="Ex: Plan Pro">
            ...
            <div>
                ...
                <textarea name="description" rows="3"
                    ...
                    placeholder="Description du plan...">{{ old('description') }}</textarea>
            </div>
            ...
            <div class="grid grid-cols-2 gap-4">
                ...
                <div>
                    ...
                    <input type="number" name="max_workers" value="{{ old('max_workers', 10) }}" min="-1"
                        ...
                        required>
                    <p class="mt-1 text-xs text-gray-500">Mettre -1 pour illimité</p>
