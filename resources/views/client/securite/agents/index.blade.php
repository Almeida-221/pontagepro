    ...
    <div class="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-3">
        ...
        <div class="flex items-center gap-2">
            <button onclick="window.print()"
                class="flex items-center gap-2 border border-gray-300 text-gray-700 px-4 py-2 rounded-lg text-sm font-medium hover:bg-gray-50 transition no-print">
            ...
            <a href="{{ route('client.securite.agents.create') }}"
                class="bg-red-700 text-white px-5 py-2 rounded-lg text-sm font-medium hover:bg-red-800 transition no-print">
                + Ajouter un membre
            </a>
        </div>
    </div>
                    ...
                    <tr class="{{ $m->is_active ? '' : 'opacity-50' }}">
                        ...
                        <td class="px-5 py-3 no-print">
                            <div class="flex items-center justify-end gap-2">
                                <a href="{{ route('client.securite.agents.planning', $m) }}"
                                    class="text-indigo-600 hover:text-indigo-800 text-xs font-medium">Planning</a>
