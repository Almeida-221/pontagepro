...
@section('title', 'Rapport Remplacements')
@section('page-title', '🔄 Rapport — Remplacements')
...
<div class="space-y-6 mt-2">
    ...
    <div class="bg-white rounded-xl border border-gray-200 p-4">
        <form method="GET" action="{{ route('client.securite.rapports.remplacements') }}"
            ...
            <div>
                ...
                <select name="zone_id" class="rounded-lg border border-gray-300 px-3 py-2 text-sm focus:ring-2 focus:ring-blue-300 outline-none">
            ...
            <div>
                ...
                <select name="poste_id" class="rounded-lg border border-gray-300 px-3 py-2 text-sm focus:ring-2 focus:ring-blue-300 outline-none">
            ...
            <div class="flex gap-2">
                <button type="submit"
                    class="bg-blue-600 text-white rounded-lg px-4 py-2 text-sm font-medium hover:bg-blue-700 transition">
                    Filtrer
                </button>
            ...
            {{-- PDF --}}
            <div class="ml-auto">
                <a href="{{ route('client.securite.rapports.remplacements.pdf', request()->query()) }}"
                   target="_blank"
    ...
    <div class="bg-white rounded-xl border border-gray-200 overflow-hidden">
        ...
        <div class="px-5 py-4 border-b border-gray-100 flex items-center gap-3">
            <h3 class="font-semibold text-gray-900">Tableau des présences par remplacement</h3>
            <div class="ml-auto">
                <input type="text" id="search-input" placeholder="Rechercher un agent…"
                       class="rounded-lg border border-gray-300 px-3 py-1.5 text-sm focus:ring-2 focus:ring-blue-300 outline-none w-56">
            </div>
        </div>
