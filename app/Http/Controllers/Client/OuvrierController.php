...
class OuvrierController extends Controller
{
    ...
    /** Jours travaillés d'un user sur une période */
    private function joursTravailles(int $userId, ?Carbon $debut = null, ?Carbon $fin = null): float
    {
        $q = OuvrierPointage::where('user_id', $userId)->where('statut', '!=', 'absent');
    ...
    {
        return $this->joursTravailles($user->id, $debut, $fin) * (float) $user->taux_journalier;
    }
